...
export async function getApplicationStudio(job:Job):Promise<ApplicationStudio>{
  ...
  try{
    ...
    const generated=studioSchema.parse(JSON.parse(data.output_text||"{}"));
